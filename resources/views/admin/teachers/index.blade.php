...
<div class="container-fluid">
    ...
    <div class="card shadow-sm border-0">
        <div class="card-body">
            ...
            {{-- Search --}}
            <form action="{{ route('admin.teachers.index') }}" method="GET" class="row g-3 mb-4">
                <div class="col-md-10">
                    <input
                        type="text"
                        class="form-control"
            ...
            <div class="table-responsive">
                <table class="table table-bordered table-hover align-middle">
                    {{-- PERBAIKAN DI SINI: Mengganti table-dark menjadi table-light --}}
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <br>
                                <small class="text-muted">{{ $teacher->education }}</small>
                            </td>
