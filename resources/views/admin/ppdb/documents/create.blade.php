...
@section('title', 'Tambah Dokumen PPDB')
		...
		<div class="card">
			<div class="card-body">
				<div class="d-flex justify-content-between align-items-baseline mb-4 mb-md-3">
					<h6 class="card-title mb-0">Tambah Dokumen PPDB</h6>
				...
				<form action="{{ route('admin.ppdb.documents.store', $ppdb) }}" method="POST" enctype="multipart/form-data">
					@csrf
						...
						<div class="col-md-8">
							...
							<div class="mb-3">
								...
								<input type="file" class="form-control @error('file') is-invalid @enderror" 
									   id="file" name="file" accept=".pdf,.doc,.docx,.xls,.xlsx,.ppt,.pptx,.jpg,.jpeg,.png,.gif,.zip,.rar" required>
								<div class="form-text">
									Format yang didukung: PDF, DOC, DOCX, XLS, XLSX, PPT, PPTX, JPG, JPEG, PNG, GIF, ZIP, RAR<br>
