		...
		<div class="card">
			<div class="card-body">
				<div class="d-flex justify-content-between align-items-baseline mb-4 mb-md-3">
					<h6 class="card-title mb-0">Tambah FAQ PPDB</h6>
				...
				<form action="{{ route('admin.ppdb.faqs.store', $ppdb) }}" method="POST">
					@csrf
						...
						<div class="col-md-8">
							...
							<div class="mb-3">
								...
								<textarea class="form-control @error('answer') is-invalid @enderror" 
										  ...
										  placeholder="Jawaban lengkap untuk pertanyaan FAQ" required>{{ old('answer') }}</textarea>
								<div class="form-text">
