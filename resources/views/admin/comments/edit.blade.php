		...
		<div class="card overflow-hidden">
			<div class="card-body">
				<div class="d-flex justify-content-between align-items-baseline mb-4 mb-md-3">
					<h6 class="card-title mb-0">Edit Komentar</h6>
					<div class="dropdown">
				...
				<div class="row align-items-start">
					<div class="col-md-7">
						<p class="text-muted tx-13 mb-3 mb-md-0">Edit komentar dari {{ $comment->name }}.</p>
					</div>
                                    ...
                                    <select class="form-select @error('pena_karsa_id') is-invalid @enderror" 
                                        ...
                                        @foreach($penaKarsaArticles as $article)
                                            <option value="{{ $article->id }}" 
                                                    {{ old('pena_karsa_id', $comment->pena_karsa_id) == $article->id ? 'selected' : '' }}>
                                                {{ $article->title }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="info-item mb-3">
                                            ...
                                            <div class="text-muted small">
                                                {{ $comment->ip_address ?? 'Tidak tersedia' }}
                                            </div>
                                        </div>
                                    ...
                                    <div class="card-body">
                                        <div class="comment-preview">
                                            <div class="d-flex align-items-center mb-2">
                                                ...
                                                <div>
                                                    <div class="comment-author fw-bold" id="previewName">{{ $comment->name }}</div>
                                                    <div class="comment-email text-muted small" id="previewEmail">{{ $comment->email }}</div>
                                                </div>
                                            </div>
