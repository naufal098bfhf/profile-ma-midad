...
<div class="container py-5">
    ...
    <div class="row">
        <div class="col-lg-8">
            ...
            <!-- Comments Section -->
            <div class="pena-karsa-comments-section mt-5">
                <!-- Comment Form -->
                @include('components.comment-form', ['penaKarsaId' => $penaKarsa->id])
                
                <!-- Comment List -->
                @include('components.comment-list', ['penaKarsaId' => $penaKarsa->id])
            </div>
        </div>
