...
@section('title', 'Galeri Madrasah - ' . config('app.name'))

@section('description', 'Galeri foto kegiatan madrasah, ekstrakurikuler, acara madrasah, dan fasilitas. Lihat dokumentasi visual kegiatan dan fasilitas madrasah kami.')

@push('styles')
    <!-- Open Graph Meta Tags for Galleries Index -->
    <meta property="og:type" content="website">
    <meta property="og:title" content="Galeri Foto Madrasah - {{ config('app.name') }}">
    <meta property="og:description" content="Galeri foto kegiatan madrasah, ekstrakurikuler, acara madrasah, dan fasilitas. Lihat dokumentasi visual kegiatan dan fasilitas madrasah kami.">
    <meta property="og:url" content="{{ url()->current() }}">
    <meta property="og:locale" content="id_ID">

    <!-- Twitter Card Meta Tags for Galleries Index -->
    <meta name="twitter:card" content="summary">
    <meta name="twitter:title" content="Galeri Foto Madrasah - {{ config('app.name') }}">
    <meta name="twitter:description" content="Galeri foto kegiatan madrasah, ekstrakurikuler, acara madrasah, dan fasilitas. Lihat dokumentasi visual kegiatan dan fasilitas madrasah kami.">
@endpush
...
<main class="container mt-4">
    ...
    <header class="row mb-4">
        <div class="col-12">
            ...
            <p class="page-subtitle">Kumpulan foto kegiatan dan fasilitas madrasah</p>
        </div>
    </header>
