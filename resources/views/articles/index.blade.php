...
@section('description', 'Kumpulan artikel dan berita terbaru dari Madrasah: kajian Al-Quran, hadis, fikih, adab, opini, tokoh, dan lainnya.')
...
<div class="container mt-4">
    ...
    <header class="row mb-4">
        <div class="col-12">
            ...
            <p class="page-subtitle">Kumpulan artikel dan berita terbaru dari Madrasah</p>
        </div>
    </header>
