...
@section('title', 'Pengumuman Madrasah - ' . config('app.name'))

@section('description', 'Daftar pengumuman terbaru dan informasi penting dari Madrasah. Temukan pengumuman akademik, kegiatan, ujian, dan libur Madrasah.')

@push('styles')
    <!-- Open Graph Meta Tags for Announcements Index -->
    <meta property="og:type" content="website">
    <meta property="og:title" content="Pengumuman Madrasah - {{ config('app.name') }}">
    <meta property="og:description" content="Daftar pengumuman terbaru dan informasi penting dari Madrasah. Temukan pengumuman akademik, kegiatan, ujian, dan libur Madrasah.">
    <meta property="og:url" content="{{ url()->current() }}">
    <meta property="og:locale" content="id_ID">

    <!-- Twitter Card Meta Tags for Announcements Index -->
    <meta name="twitter:card" content="summary">
    <meta name="twitter:title" content="Pengumuman Madrasah - {{ config('app.name') }}">
    <meta name="twitter:description" content="Daftar pengumuman terbaru dan informasi penting dari Madrasah. Temukan pengumuman akademik, kegiatan, ujian, dan libur Madrasah.">
@endpush
...
<main class="container mt-4">
    ...
    <header class="row mb-4">
        <div class="col-12">
            ...
            <p class="page-subtitle">Informasi terbaru dan pengumuman penting dari Madrasah</p>
        </div>
    </header>
